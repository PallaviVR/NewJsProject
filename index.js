...
function load(){
    ...
    //right bottom most dots

    html+=`<div class="dot" style="z-inddex=${i};left:${sx+m*offset-5}px;top:${sy+n*offset-5}px;" data-active="false"></div>`
...
function computerSelect(id){
    ...
    $("div.line[data-line-1='''+id'''],div.line[data-line-2='''+id+''']").each(function(i,v){
        if(!$(v).hasClass("line-active")){
            ...
            console.log("___"+turn);

            if(checkVlaid(v)&& turn===false){
                console.log("___");
                if(id1>=0)var a=addValue(id1);
                if(id2>=0)var b=addValue(id2);
